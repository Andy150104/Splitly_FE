...
import type { PagedResultGetSupportRequests } from './pagedResultGetSupportRequests';

export interface ApiResponsePagedGetSupportRequests {
  success?: boolean;
  /** @nullable */
  message?: string | null;
  data?: PagedResultGetSupportRequests;
  /** @nullable */
